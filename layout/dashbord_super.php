                ...
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-8">
                        <div class="mb-3">
                          <label class="form-label" for="inputUsername" required>Password</label>
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="inputUsername">Re-Password</label>
                          <input type="password" class="form-control " name="password" id="inputPassword" placeholder="password">
                        </div>
