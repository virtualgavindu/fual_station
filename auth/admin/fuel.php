                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="fuelType" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="btn btn-primary" type="submit" name="btn-updatePrice" value="Update">
                                    <?php if (!empty($msg)) {
