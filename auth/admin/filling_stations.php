        ...
        if($ShowResult){
            ...
            elseif(mysqli_num_rows($ShowResult1)==1)
            {
                ...
                if($ShowResult2){
                    ...
                    $query4="INSERT INTO fuel_stock (station_id,fuel_id,stock)VALUES ('{$fuelStation_ID}',1,0),('{$fuelStation_ID}',2,0),('{$fuelStation_ID}',3,0),('{$fuelStation_ID}',4,0),('{$fuelStation_ID}',5,0)";
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    <form action="filling_stations.php" method="POST">
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       id="inputFirstName" placeholder="Fuel station ID" name="fuelStation_ID">
                                                            </div>
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label"
                                                                       for="inputFirstName">Manager ID</label>
                                                                <input type="text" class="form-control"
                                                                       id="inputFirstName" placeholder="Manager ID" name="manager_ID">
                                                            </div>
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label" for="inputLastName" >Filling
                                                                    Staion Name</label>
                                                                <input type="text" class="form-control"
                                                                       id="inputLastName" placeholder="Filling station name" name="fuelStationName">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="btn-RegStation">Save changes
                                                        </button>
                                                        <?php if (!empty($msg)) {
